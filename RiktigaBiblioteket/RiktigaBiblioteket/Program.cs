...
namespace Biblotek
{
    ...
    class Program
    {
        ...
        static void RegisterUser()
        {
            ...
            {
                Console.WriteLine("Ogiltig information. Glöm inte sista fyra.");
                return;
            }
            ...
            if (!IsUserInfoIncomplete(firstName, lastName, personalNumber, password))
            {
                if (!IsUserRegistered(firstName, lastName, personalNumber))
                {
                    ...
                    File.AppendAllText(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\Users.txt", line + Environment.NewLine);
                    File.AppendAllText(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\personal_numbers.txt", dataForPn + Environment.NewLine);
                    File.AppendAllText(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\password.txt", dataForPassword + Environment.NewLine);
        ...
        {
            string[] users = File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\users.txt");
        ...
        {
            string[] personalNumbersFromDb = System.IO.File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\personal_numbers.txt");
            string[] passwordsFromDb = System.IO.File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\password.txt");
        ...
        static void ChangePassword(string personalNumber)
        {
            ...
            string[] personalNumbersFromDb = File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\personal_numbers.txt");
            string[] passwordsFromDb = File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\password.txt");
            string[] usersFromDb = File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\users.txt");
            ...
            for (int i = 0; i < personalNumbersFromDb.Length; i++)
            {
                if (personalNumbersFromDb[i] == personalNumber)
                {
                    ...
                    File.WriteAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\password.txt", passwordsFromDb);
                    File.WriteAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\users.txt", usersFromDb);
        ...
        static void SearchBook()
        {
            ...
            library.AddBook(new Book("In Sheep's Clothing: Understanding and Dealing with Manipulative People"," George K. Simon Jr." , "84234201520"));
            library.AddBook(new Book("The 48 Laws of Power", "Robert greene", "931357439"));
            library.AddBook(new Book("Alternativa fakta om fåglar"," John Ajvide Lindquist", "123456789"));
            library.AddBook(new Book("Turisten", "Christina Olseni", "12321343123123"));
            library.AddBook(new Book("Pippi Långstrump", "Astrid Lindgren", "2492349237"));
        ...
        static void BorrowBook()
        {
            ...
            File.AppendAllText(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\borrowedBooks.txt", userData + Environment.NewLine);
        ...
        static void ReturnBook()
        {
            ...
            string[] lines = File.ReadAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\borrowedBooks.txt");
            bool found = false;
            ...
            if (found)
            {
                File.WriteAllLines(@"C:\Users\adam.zahirovic\source\repos\RiktigaBiblioteket\RiktigaBiblioteket\borrowedBooks.txt", lines.Where(line => line != null));
